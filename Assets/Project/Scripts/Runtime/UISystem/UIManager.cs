...
public class UIManager : Singleton<UIManager> {
    [Header("References")]
    [Space(2)]
    public SerializedDictionary<string, ScreenController> UIScreensDictionary = new();
    public string startingScreen = "";
    public ScreenController currentShownUIScreen;
    ...
    private void HideAllScreens(ScreenController exceptionScreen = null) {
        foreach (ScreenController screen in UIScreensDictionary.Values) {
