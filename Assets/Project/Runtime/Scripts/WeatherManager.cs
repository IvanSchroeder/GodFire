...
namespace WorldSimulation {
    public class WeatherManager : Singleton<WeatherManager> {
        ...
        void Update() {
            ...
            if (_isSavingData || WeatherData.IsNull()) return;
            UpdateWeather();
        }
        ...
        public void SaveWeatherData() {
            ...
            string json = JsonConvert.SerializeObject(inputWeather);
            File.WriteAllText(_dataPath, json);

            _isSavingData = false;

            Debug.Log($"Saved Weather Data at {_dataPath}!");
        }
        ...
        public void LoadWeatherData() {
            ...
            if (timeExists) {
                ...
                Debug.Log($"Loaded Weather Data at {_dataPath}!");
            }
            else {
        ...
        public void CreateNewWeatherData() {
            ...
            Debug.Log($"Created new Weather Data at {_dataPath}!");
        }
        ...
        public void DeleteWeatherData() {
            ...
            if (File.Exists(_dataPath)) {
                ...
                Debug.Log($"Deleted Weather Data at {_dataPath}!");
            }
            else {
